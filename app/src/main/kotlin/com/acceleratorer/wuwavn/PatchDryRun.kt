...
data class PatchDryRun(
    ...
    fun describe(): String = buildString {
        ...
        append("\n\nUnlocked write flows are separate and verified: PAK-only install, Safe / Default config preset, Balanced config preset, and Remove Patch with MountLang rollback. Performance and Max Graphics remain locked.")
    }
