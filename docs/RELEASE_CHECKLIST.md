...
- Name the APK like `WUWA-VN-v3.3.10-release.apk`.
...
It also downloads and verifies the JetBrains Kotlin compiler zip before compiling app sources from `app/src/main/kotlin`.
...
sha256sum WUWA-VN-v3.3.10-release.apk
```
